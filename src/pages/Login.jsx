        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-text-secondary mt-2">
              {isLogin 
                ...
                : 'Join us and enjoy delicious pizzas at your doorstep'
              }
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-md p-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 px-4 py-2.5 border border-border rounded-lg hover:bg-gray-light transition-colors">
          ...
          <div className="text-center mt-6">
            <Link to="/" className="text-text-secondary hover:text-primary-red">
              ← Back to Home
            </Link>
          </div>
        </div>
